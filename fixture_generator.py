...
def berger_table(teams, double=True):
    ...
    [[0 v 3, 1 v 2], [3 v 2, 0 v 1], [1 v 3, 2 v 0]]
    ...
    [[0 v 5, 1 v 4, 2 v 3], [5 v 3, 4 v 2, 0 v 1], [1 v 5, 2 v 0, 3 v 4], [2 v 5, 3 v 1, 4 v 0], [5 v 4, 0 v 3, 1 v 2], [5 v 0, 4 v 1, 3 v 2], [3 v 5, 2 v 4, 1 v 0], [5 v 1, 0 v 2, 4 v 3], [5 v 2, 1 v 3, 0 v 4], [4 v 5, 3 v 0, 2 v 1]]
    """
    def rotate(arr, dist):
